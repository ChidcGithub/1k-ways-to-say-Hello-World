...
era: classic
tags: []
notes: Uses multiplication-table loading pattern to fill cells
author: ChidcGithub
date: 2026-07-20
---

# #0394 · Brainfuck multiplication-table

## Description

A Brainfuck Hello World entry: Uses multiplication-table loading pattern to fill cells
...
```bash
cd hello-worlds/brainfuck/0394-multiplication-table
beef hello.bf
```
...
| tags | [] | Uses multiplication-table loading pattern to fill cells |
